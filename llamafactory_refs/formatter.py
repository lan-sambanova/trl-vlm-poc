# Copied from: src/llamafactory/data/formatter.py
import json
import re
...
from llamafactory_refs.data_utils import SLOTS
from llamafactory_refs.tool_utils import get_tool_utils


if TYPE_CHECKING:
    from llamafactory_refs.tool_utils import FunctionCall
